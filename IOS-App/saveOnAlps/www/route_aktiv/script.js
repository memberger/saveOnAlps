...
function HandleLocationResponse(response)
{
	...
	lastEntry = 0;
	document.getElementById('_long').innerHTML=long.toString().substring(0,7);
    document.getElementById('_lat').innerHTML=lat.toString().substring(0,7);
    document.getElementById('_accu').innerHTML=accu;
	document.getElementById('_long').style="color:#999999";
...
function updateIndikator(){
	...
	{
    document.getElementById('_time').innerHTML=minutes+"'";
	}
